...
<div class="box_tit dp_c dp_sb">
	...
	<a href="/job/up_index.php?type=write" class="btn_primary02">등록</a>
</div>
<div class="tbl">
...
<?
	...
	$record_count = 6;  //한 페이지에 출력되는 레코드수
...
?>
				...
				<div class="tbl_tr board_flex">
					<div class="tbl_td" onclick="<?=$java_link?>('<?=$uid?>','업무');"><?=$title?> <?=$new_icon?></div>
					<div class="tbl_td" onclick="<?=$java_link?>('<?=$uid?>','업무');"><?=$project?></div>
					<div class="tbl_td" onclick="<?=$java_link?>('<?=$uid?>','업무');"><?=$status?></div>					
