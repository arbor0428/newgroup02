...
.week {font-family:돋움,돋움체;background-color:#eeeeee;color:#464646;font-size:12px;font-weight:bold;letter-spacing:-1;height:30px;}
					...
					<td align='center'>
						<table cellSpacing='0' cellPadding='0' border='0'>
							<tr>
								...
								<td style='padding:0 10 0 10;' align='center'><font class='title'><?=$year?>년 <?=$month?>월</font></td>
