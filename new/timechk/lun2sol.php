...
/****************** 휴일 정의 ************************/
$HOLIDAY = Array();
$HOLIDAY[] = array(0=>'0101',1=>'신정'); 
$HOLIDAY[] = array(0=>'0301',1=>'삼일절');
$HOLIDAY[] = array(0=>'0505',1=>'어린이날');
$HOLIDAY[] = array(0=>'0606',1=>'현충일');
$HOLIDAY[] = array(0=>'0815',1=>'광복절');
$HOLIDAY[] = array(0=>'1003',1=>'개천절');
$HOLIDAY[] = array(0=>'1225',1=>'성탄절');

$tmp = lun2sol($f_year."0101");   //설날
$HOLIDAY[] = array(0=>date("md",($tmp-(3600*24))),1=>'설연휴');
$HOLIDAY[] = array(0=>date("md",$tmp),1=>'설날');
$HOLIDAY[] = array(0=>date("md",($tmp+(3600*24))),1=>'설연휴');;

$tmp = lun2sol($f_year."0408");   //석가탄신일
$HOLIDAY[] = array(0=>date("md",$tmp),1=>'석가탄신일');

$tmp = lun2sol($f_year."0815");   //추석
$HOLIDAY[] = array(0=>date("md",($tmp-(3600*24))),1=>'추석연휴');;
$HOLIDAY[] = array(0=>date("md",$tmp),1=>'추석');;
$HOLIDAY[] = array(0=>date("md",($tmp+(3600*24))),1=>'추석연휴');


$OneFreeDay = Array();
$OneFreeDay['20180507'] = '대체공휴일';
