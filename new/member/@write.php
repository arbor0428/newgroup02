...
/*
	...
	if(isFrmEmpty(form.nate,"네이트를 입력해 주십시오"))	return;
	if(isFrmEmpty(form.addr,"주소를 입력해 주십시오"))	return;
*/
			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='gTable2'>
				<tr> 
					...
					<?
						if($type=='write'){
					?>
						<input type='text' name='userid' style='width:150px;' value=''>
					<?
						}else{
					?>
						<?=$userid?>
				...
				<tr> 
					...
					<td width="33%">
						<input type='text' name='securi' style='width:60px;' value='<?=$securi?>' maxlength='6'> - <input type='text' name='securi2' style='width:70px;' value='<?=$securi2?>' maxlength='7'>
					</td>
				</tr>
