...
if($idate01 && $idate02 && $idate03)   $itime = mktime(0,0,0,$idate02,$idate03,$idate01);
   ...
   if($type == 'write'){
         ...
         $sql = "insert into wo_member  (userid,pwd,name,securi,securi2,team,mtype,mname,mobile,telephone,email,bir01,bir02,bir03,account,enable,idate01,idate02,idate03,itime,sex,zipcode,addr01,addr02,affil,pdate01,pdate02,pdate03) values ";
         $sql .= "('$userid','$pwd','$name','$securi','$securi2','$team','$mtype','$mname','$mobile','$telephone','$email','$bir01','$bir02','$bir03','$account','$enable','$idate01','$idate02','$idate03','$itime','$sex','$zipcode','$addr01','$addr02','$affil','$pdate01','$pdate02','$pdate03')";
         $result = mysql_query($sql);
         $msg = '등록되었습니다';
