	...
	<div class="leave_wrap">
		<div class="tbl">
			<div class="tbl_tr tbl_tit_tr board_flex leave_row">				
				...
				<div class="tbl_th board_title pc_only" >소속</div>
				<div class="tbl_th board_title pc_only" >직위</div>
				<div class="tbl_th board_title" >신청자</div>
				<div class="tbl_th board_title" >휴가기간</div>
				<div class="tbl_th board_title pc_only" >사용용도</div>
				<div class="tbl_th board_title" >승인여부</div>
				<div class="tbl_th board_title pc_only" >삭제</div>
			</div>
	<?
		...
		?>
				<div class="tbl_tr tbl_tit_tr board_flex leave_row">
					...
					<div class="tbl_td " onclick="reg_view('<?= $uid ?>');" style="font-weight:600; color: <? if ($status=='승인') {echo "#0b0";} else if ($status == '반려') {echo "#f00";} else {echo "#777";}?>;"><?= $status ?></div>
