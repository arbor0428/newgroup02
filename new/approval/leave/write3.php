    ...
    <main>
      ...
      <div class="agreeForm">
        <table class="agreeTable" id="agreeTableWrap">
          ...
          <div class="dealCheckBox">합의<input type="checkbox" onclick="getCheckValue(event)" />
      ...
      <div id="submitForm">
        ...
        <table class="inputTable">
          <tr class="inputForm">
            <th>제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목</th>
            <td id="mainTitle_wrap"><textarea name="mainTitle" id="mainTitle" rows="1" class="title " placeholder="연차 사용"></textarea></td>
          </tr>
          <tr class="inputForm">
            <th>사&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;유</th>
            <td id="content_wrap"><textarea name="content" id="content" cols="30" rows="4" class="content" placeholder="개인 사유"></textarea></td>
          </tr>
          <tr class="inputForm">
            <th>휴&nbsp;가&nbsp;종&nbsp;류</th>
            <td id="dayoff_wrap">
