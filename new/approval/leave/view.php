...
?>
<div class="title no-print none_print">
	<div class="none_print">
		<a href='up_index.php?type=list' class="big cbtn black no-print none_print">목록</a>
	</div>
</div>
	...
	<form name="frm" id="frm" method="get">
		...
		<header>
			...
			<div class="submitWrap no-print">
				...
				<a href="javascript:window.print();" class="big cbtn blue none_print">인쇄하기</a>
			</div>
		</header>

		<section>

			<div class="agreeForm none_print">
			...
			<div class="submitForm">
				...
				<div class="etc-wrap no-print none_print">
					<h2 class="etcTitle">
						3. 기타
