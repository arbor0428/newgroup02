					...
					<td>
						<table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse:collapse;" bordercolor="cccccc" frame="hsides" class='s'>
							...
							<tr>
								...
								<td class='tab'><input type='text' name='ftpcapa[]' style='width:215px;' value='<?=$ao02?>'></td>
								<td class='tab_tit30'>청구가격</td>
								<td class='tab'><input type='text' name='ftpprice[]' style='width:100px;' value='<?=$ao03?>'></td>								
							</tr>
							<tr>
						...
						<table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse:collapse;" bordercolor="cccccc" frame="hsides" class='s'>
							<tr>
								...
								<td width="33%" class='tab'>
									<select name='ftptype[]'>
										<option value=''>호스팅해당없음</option>
										<option value='아이웹이용'>아이웹이용</option>
										<option value='독립형[자동청구]'>독립형[자동청구]</option>
										<option value='독립형[수동청구]'>독립형[수동청구]</option>
									</select>
								</td>								
							</tr>
							<tr>
