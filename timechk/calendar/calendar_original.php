...
if(!$c_path) $c_path=".";
if(!$cellh) $cellh  = 20;  // date cell height
if(!$tablew) $tablew = 170; //table width
?>
...
font.num2 {font-family:tahoma; font-size:12px; color:#bbbbbb;}
</style>
...
<TR><TD align=center>
		...
		<TR><TD width=15% align=center>
		        <a href=$PHP_SELF?year=$prevyear&month=$prevmonth&day=1 onfocus='this.blur()'><img src='$c_path/img/c_pre.gif' border=0 onfocus='this.blur();' align=absmiddle width=8 height=7></a>        
            </TD>
			<TD width=70% align=center>
				<font class=title>{$year}년 {$month}월</font>
            </TD>
			<TD width=15% align=center>
				<a href=$PHP_SELF?year=$nextyear&month=$nextmonth&day=1 onfocus='this.blur()'><img src='$c_path/img/c_next.gif' border=0 onfocus='this.blur();' align=absmiddle width=8 height=7></a>
	        </TD>
		</TR>		
		</TABLE>
    </TD>
...
while ($date <= $maxdate) {   
   ...
   if ( $date == $today  &&  $year == $thisyear &&  $month == $thismonth) echo "<TD align=center valign=middle><TABLE cellpadding=0 cellspacing=0 border=0 width=20 height=20><TR><TD background='$c_path/img/date_bg.gif' align=center><font class=num>$date2</font></TD></TR></TABLE></TD> \n";
